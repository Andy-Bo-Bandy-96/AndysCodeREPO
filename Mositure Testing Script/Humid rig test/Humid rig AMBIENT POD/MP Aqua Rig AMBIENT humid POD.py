...
url = "http://changeme-f8dc7a7a15ac.local:4030/vanguard/envSensor/5"

# CSV file path to write data
csv_file = r"C:\Users\Andre\OneDrive\Desktop\Material Pod Testing Scripts\Mositure Testing Script\Humid rig test\AmbientHUMID_data.csv"
...
while True:
    ...
    time.sleep(1800)  # Sleep for 1800 seconds (30 minute)
