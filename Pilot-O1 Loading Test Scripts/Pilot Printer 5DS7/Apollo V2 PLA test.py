...
URL_BASE = "http://apollo-v2-el.local:4030/"
s = Session()
...
def main():
    ...
    for i in count(0):
        ...
        for mp in mps:
            ...
            time_consuming_task.mp_feed_filament_forward(mp, 34).start_and_wait_til_done() # 50mm? Idk
            ...
            while True:
                ...
                run_multiple_time_consuming_tasks_in_parallel(
                    ...
                    time_consuming_task.extrude(27.5, 510), # distance 10mm, rate 600
