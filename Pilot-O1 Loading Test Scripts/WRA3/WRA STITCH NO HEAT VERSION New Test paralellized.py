...
def main():
    ...
    CUT_L = 65 # 515mm, @700mm -> 600mm, @850mm->?
    for i in count(0):
        ...
        for mp in mps:
            ...
            time_consuming_task.mp_feed_filament_forward(mp, 45).start_and_wait_til_done() # 50mm? Idk
            ...
            while True:
                ...
                run_multiple_time_consuming_tasks_in_parallel(
                    ...
                    time_consuming_task.extrude(45, 550), # distance 10mm, rate 600
                    time_consuming_task.mp_feed_filament_forward(mp, 39),
                    # you can run more than 2 in parallel. as many as you want
                    # ...
                )
                odometer_value = instantaneous_task.read_printhead_encoder()
                if odometer_value >= 29:
                    break
