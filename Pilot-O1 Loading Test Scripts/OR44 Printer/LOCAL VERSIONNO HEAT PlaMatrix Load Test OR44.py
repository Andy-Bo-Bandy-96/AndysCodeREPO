...
def main():
    ...
    CUT_L = 95 # 515mm, @700mm -> 600mm, @850mm->?
    for i in count(0):
        ...
        for mp in mps:
            ...
            time_consuming_task.mp_feed_filament_forward(mp, 28).start_and_wait_til_done() # 50mm? Idk
            ...
            while True:
                ...
                run_multiple_time_consuming_tasks_in_parallel(
                    ...
                    time_consuming_task.extrude(27.5, 600), # distance 10mm, rate 600
            ...
            run_multiple_time_consuming_tasks_in_parallel(
                time_consuming_task.extrude_until_printhead_switch_is_released_and_then_extrude_one_more_time(300), # rate 300
