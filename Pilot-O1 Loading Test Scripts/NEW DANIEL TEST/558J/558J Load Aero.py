...
URL_BASE = "http://558j-ela.local:4030/"
s = Session()
...
def to_nozzle_hack2(i, myfile, materialPod: int, CUT_L) -> None:
    ...
    SWITCH2ENCODER = 17 #tbh when I measured, should be 17mm, but OK w/e
    ENCODER2DRIVE = 30#mm
    MAX_TRIES = 10 # ATTENTION ANDREW
    SF_L = 5 #mm, safety factor length
    MP_FR = 25 # steps/s  # ATTENTION ANDREW
